...
public class OrderRepositoryTest {
    ...
    // Happy path test: Use save to add a new Order
    @Test
    void testSaveCreate() {
    ...
    // Unhappy path test: Use findAllByAuthor to find Order using an all-lowercase name (this is to check case sensitivity of author).
    @Test
